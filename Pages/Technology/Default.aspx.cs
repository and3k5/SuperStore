...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("SELECT ProductID,Category,ProductVendor,ModelName,Description,Image,Price FROM SaleItems WHERE Category = '1' OR Category = '2'", con);
        con.Open();
